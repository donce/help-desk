...
\section{Personos}
	...
	\subsection{Inžinierius}
		...
		\subsubsection{Būsimos sistemos kompiuterizuotų užduočių panaudojimo tikslai}
			...
			\begin{itemize}
				\item Užduoties pažymėjimas, kaip atliktos su komentaru turi užtrukti ne daugiau kaip 3 min.
				\item Užduoties perdavimas atgal administratoriui su komentaru turi užtrukti ne daugiau kaip 4 min.
			\end{itemize}

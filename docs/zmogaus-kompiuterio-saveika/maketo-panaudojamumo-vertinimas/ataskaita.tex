...
\subsection{Santrauka}
	...
	\begin{table}[ht] 
		...
		\begin{tabular}{c c} % centered columns (2 columns) 
			...
			Kodas & Vertintojas\\ [0.5pt] % inserts table 
			%heading 
	...
	\subsubsection{Problemos ir taisymo rekomendacijos}
		...
		\hline\hline %inserts double horizontal lines 
		Nr. & Problema & Sprendimas\\ [0.5pt] % inserts table 
		%heading 
		\hline % inserts single horizontal line 
		1 &
		...
		\hline %inserts single line 
		\end{tabular} 
		\label{table:rekomendacijos} % is used to refer this table in the text 
		\end{table} 
...
\subsection{Vertinimo aplinka}
	\begin{table}[h] 
	\caption{Vertinimo aplinka} % title of Table 
	\centering % used for centering table 
	\begin{tabular}{c c c c c c} % centered columns (6 columns) 
	\hline\hline %inserts double horizontal lines 
	Vertintojas & U & K & D & R & O \\ [0.5pt] % inserts table 
	%heading 
	\hline % inserts single horizontal line 
	...
	Vertinimo laikas & 18:00-20:00 & 18:00-20:00 & 18:00-20:00 & 18:00-20:00 & 18:00-20:00\\
	\hline %inserts single line 
	\end{tabular} 
	\label{table:aplinka} % is used to refer this table in the text 
	\end{table} 
...
\subsection{Teigiami įspūdžiai}
	...
	Žr. paveikslėlius:
	\referToPicture{TEIGIAMAS-1.png} ,
	\referToPicture{TEIGIAMAS-2.png} ,
	\referToPicture{TEIGIAMAS-3.png}

	\insertPicture[0.8]{TEIGIAMAS-1.png}{Teigiami įspūdžiai}
	
	\insertPicture[0.8]{TEIGIAMAS-2.png}{Teigiami įspūdžiai}
	
	\insertPicture[0.8]{TEIGIAMAS-3.png}{Teigiami įspūdžiai}
...
4 lentelėje pateikiame principus. 5 lentelė - defektų sąrašas.
	...
	\begin{table}[h] 
		...
		\begin{tabular}{c l} % centered columns (2 columns) 
			\hline\hline %inserts double horizontal lines 
			Kodas & Principas\\ [0.5pt] % inserts table 
			%heading 
			\hline % inserts single horizontal line 
			1 & Būsenos matomumas \\
			...
			\hline %inserts single line 
		\end{tabular} 
		\label{table:principai} % is used to refer this table in the text 
	\end{table} 
	...
	\hline\hline %inserts double horizontal lines 
	Nr. & Problema & Rado & Principas & Prioritetas\\ [0.5pt] % inserts table 
	%heading 
	\hline % inserts single horizontal line 
	1 &
	\begin{tabular}{l}Administratorius>Registrai, mygtukas\\"Importuoti" per arti kitų mygtukų.\end{tabular} &
	...
	\hline %inserts single line 
	\end{tabular} 
	\label{table:defektai} % is used to refer this table in the text 
	\end{table} 

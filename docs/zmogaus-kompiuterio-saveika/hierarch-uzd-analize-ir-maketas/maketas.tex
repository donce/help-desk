...
\subsection{Administratorius}
	...
	Jei veiksmas: šalinti įrašą. Lange \referToPicture{admin-tvarkyti_registrus.png} reikia pasirinkti registro tipą ir ištrinti eilutę iš lentelės.

	Jei veiksmas: pridėti įrašą. Lange \referToPicture{admin-tvarkyti_registrus.png} reikia pasirinkti registro tipą ir sukurti eilutę lentelėje.

	Jei veiksmas: redaguoti įrašą. Lange \referToPicture{admin-tvarkyti_registrus.png} reikia pasirinkti registro tipą, pakeisti reikiamo registro eilutės duomenis.

	Jei veiksmas: duomenų importas. Lange \referToPicture{admin-tvarkyti_registrus.png} reikia spausti migtuka importuoti ir pasirinkti duomenų failą.
